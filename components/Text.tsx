...
export function Socialmedia() {
    return (
        <>
            <table>
                <tr>
                    <td className={styles.Brand}><Link href={"https://discord.gg/xUD9p6vr"}   ><BsDiscord /></Link></td>
                    <td className={styles.Brand}> <Link href={"https://twitter.com/Pikachufan1993"}   ><AiFillTwitterCircle /></Link></td>
                    <td className={styles.Brand}><Link href={"https://www.instagram.com/darcfox93/?hl=es-la"}   ><AiFillInstagram /></Link></td>
                    <td className={styles.Brand}><Link href={"https://www.twitch.tv/darcfox93"}   ><TbBrandTwitch /></Link></td>
                </tr>
            </table>
        </>
    )
